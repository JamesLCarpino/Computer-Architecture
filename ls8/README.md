...
- Write a short 3-10-word description of what each file does.
  cpu.py holds all the cpu functionality. It has a class to handle all the methods on the CPU like ALU functionality, trace, and run.

  ls8.py is the main emulator file that loads and runs the cpu.

- Note what has been implemented, and what hasn't.
  the op of ADD has been implemented, need to implement the SUB.
  trace prints the pc and the ram read for specfici pc placement.
